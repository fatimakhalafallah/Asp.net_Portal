...
public partial class UsersArea_DID_IT : System.Web.UI.Page
{
    ...
    void Comments_Field()
    {
        ...
        string connectionString = ConfigurationManager.ConnectionStrings["PetroneedsConnectionString"].ConnectionString;
        string sql = "SELECT ICT_COMMENT FROM ICT_TELE WHERE FORM_STATUS='16' AND FORM_NO= '" + TextBox1.Text + "'";
    ...
    private void UpdateFormStatus()
    {
        ...
        if (TextBox1.Text != "")
        {
                ...
                sql = "UPDATE ICT_TELE SET FORM_STATUS = '18' WHERE FORM_NO = '" + TextBox1.Text + "'";
    ...
    private void ExportGridToPDF()
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=DID_RequestForm.pdf");
