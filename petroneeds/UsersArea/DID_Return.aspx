<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/UsersArea/MasterPage.master" CodeFile="DID_Return.aspx.cs" Inherits="UsersArea_DID_Return" %>
                    ...
                    <table cellpadding="0" cellspacing="0" class="style7">
                            ...
                            <td class="style46" colspan="3">
                                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
                                    ...
                                    <AlternatingRowStyle BackColor="White" />
                                       ...
                                       <asp:TemplateField HeaderText="Justification" ItemStyle-Width="150">
                                       <ItemTemplate>
                                        <asp:Label ID="QU" runat="server" Text='<%# Bind("JUSTIFICATION") %>'></asp:Label>
                                        </ItemTemplate>
                                      <EditItemTemplate>
                                    <asp:TextBox ID="txtju" runat="server" Text='<%# Bind("JUSTIFICATION") %>'></asp:TextBox>
                                     </EditItemTemplate>
                                        </asp:TemplateField>
                        ...
                        <tr>
                           ...
                           <tr>
                            ...
                            <tr>
                                <td class="style44">
                                    <asp:Label ID="Label4" runat="server" Text="GM Comment" Font-Size="12px" ForeColor="Maroon"></asp:Label>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                </td>
