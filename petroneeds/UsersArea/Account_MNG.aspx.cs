...
public partial class UsersArea_Account_MNG : System.Web.UI.Page
{
    ...
    private DataView Getdata()
    {
        ...
        string sql = "SELECT FORM_NO,FORM_DATE,REQUEST_USER,USER_FULL_NAME,USER_DEPARTMENT,ACCOUNT_TYPE ,EMPLOYEE_NAME,DECODE(FORM_STATUS,1,'Pending',2,'MNG Approve',3,'MNG Disapprove',4,'ICT MNG Approve',5,'ICT MNG Disapprove',7,'Complete') AS FORM_STATUS FROM REQUEST_ACTORS,ICT_NEW_ACCOUNT INNER JOIN EMPLOYEES ON EMPLOYEES.EMPLOYEE_NO=ICT_NEW_ACCOUNT.REQUEST_EXECUTOR  WHERE REQUEST_ACTORS.REQUEST_TYPE_ID = '31' AND REQUEST_ACTORS.EMPLOYEE_NO='" + EMPLOYEE_NO + "' ORDER BY FORM_NO ASC";
        ...
        ad.Fill(ds, "ICT_NEW_ACCOUNT");
        DataView dv = ds.Tables["ICT_NEW_ACCOUNT"].DefaultView;
        con.Close();
        return dv;  
    }
