<%@ Page Title="" Language="C#" MasterPageFile="~/UsersArea/MasterPage.master" AutoEventWireup="true" CodeFile="ICT_Return_EQ.aspx.cs" Inherits="UsersArea_ICT_Return_EQ" %>
        ...
        <tr>
            ...
            <td class="style9">
               <asp:GridView ID="GridView1" runat="server" Width="600px" AllowPaging="True" 
                    ...
                    onselectedindexchanged="GridView1_SelectedIndexChanged" ForeColor="#CC0000">
                    <Columns>
                            ...
                            <td class="style46" colspan="3">
                                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
                                    ...
                                    <AlternatingRowStyle BackColor="White" />
                                       ...
                                       <asp:TemplateField HeaderText="REQ_NO" ItemStyle-Width="150">
                                        <ItemTemplate>
                                       ...
                                       <asp:TextBox ID="txtr" runat="server" ReadOnly="true" Text='<%# Bind("REQ_NO") %>'></asp:TextBox>
                                        ...
                                        <asp:TemplateField HeaderText="Form_no" ItemStyle-Width="150">
                                        <ItemTemplate>
                                       ...
                                       <asp:TextBox ID="txtFO" runat="server" ReadOnly="true" Text='<%# Bind("FORM_NO") %>'></asp:TextBox>
                                        ...
                                        <asp:TemplateField HeaderText=" EQ_Name" ItemStyle-Width="150">
                                        <ItemTemplate>
