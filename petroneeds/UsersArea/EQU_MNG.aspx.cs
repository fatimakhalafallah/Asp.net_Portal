...
public partial class UsersArea_EQU_MNG : System.Web.UI.Page
{
    ...
    private DataView Getdata()
    {
        ...
        //string sql="SELECT DISTINCT ICT_TELE.FORM_NO, ICT_TELE.FORM_DATE, ICT_TELE.USER_NAME,ICT_TELE.USER_DEP,EMPLOYEES.EMPLOYEE_NAME,DECODE(ICT_TELE.FORM_STATUS,8,'Pending',9,'MNG Approve',10,'MNG Disapprove',11,'SMNG Approve',12,'SMNG Disapprove',13,'GM Approve',14,'GM Disapprove',15,'Return', 16 ,'ICT MNG Approve',17,'ICT MNG Disapprove',18,'Complete') AS FORM_STATUS FROM REQUEST_ACTORS,ICT_TELE INNER JOIN EMPLOYEES ON EMPLOYEES.EMPLOYEE_NO=ICT_TELE.REQUEST_EXECUTOR  WHERE REQUEST_ACTORS.REQUEST_TYPE_ID = '31' AND REQUEST_ACTORS.EMPLOYEE_NO='"+EMPLOYEE_NO+"' AND ICT_TELE.DID='1' ORDER BY FORM_NO ASC";

        string sql = "SELECT ICT_MSTR.FORM_NO ,ICT_MSTR.FORM_DATE , ICT_MSTR.REQUESTER_NAME, ICT_MSTR.DEP_NO,EMPLOYEES.EMPLOYEE_NAME,DECODE(ICT_MSTR.FORM_STATUS,1,'Pending',2,'MNG Approve',3,'MNG Disapprove',4,'SMNG Approve',5,'SMNG Disapprove', 6 ,'ICT MNG Approve',7,'ICT MNG Disapprove',8,'Return',9,'Complete') AS FORM_STATUS FROM ICT_MSTR,REQUEST_ACTORS, EMPLOYEES WHERE EMPLOYEES.EMPLOYEE_NO=ICT_MSTR.REQUEST_EXECUTOR AND REQUEST_ACTORS.REQUEST_TYPE_ID = '31' AND REQUEST_ACTORS.EMPLOYEE_NO='"+EMPLOYEE_NO+"' ORDER BY FORM_NO ASC";
          
        
        // 8 PENDING , 9 MNG APPROVE , 10 MNG DISAP , 11 SMNG APP, 12 SMNG DIS, 13 GM APPRO, 14 GM DISAP,  15 RETURN ,  16 ICT
