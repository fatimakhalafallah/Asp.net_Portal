...
public partial class UsersArea_EQU_IT : System.Web.UI.Page
{
    ...
    void Comments_Field()
    {
        ...
        string connectionString = ConfigurationManager.ConnectionStrings["PetroneedsConnectionString"].ConnectionString;
        string sql = "SELECT ICT_MSTR.IMNG_COMMENT FROM ICT_MSTR WHERE ICT_MSTR.FORM_STATUS='6' AND ICT_MSTR.FORM_NO= '" + TextBox1.Text + "'";
    ...
    private void UpdateFormStatus()
    {
        ...
        if (TextBox1.Text != "")
        {
                ...
                sql = "UPDATE ICT_MSTR SET FORM_STATUS = '9'WHERE FORM_NO = '" + TextBox1.Text + "'";
    ...
    private void ExportGridToPDF()
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=EQ Request.pdf");
