<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/UsersArea/MasterPage.master" CodeFile="EQU_Approve.aspx.cs" Inherits="UsersArea_EQU_Approve" %>
        ...
        <tr>
            ...
            <td class="style9">
               <asp:GridView ID="GridView1" runat="server" Width="600px" AllowPaging="True" 
                    ...
                    ShowHeaderWhenEmpty="True" ForeColor="Maroon"
                ...
                <asp:Panel ID="Panel1" runat="server" Width="600px">
                    <table cellpadding="0" cellspacing="0" class="style7">
                            ...
                            <td class="style46" colspan="3">
                                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="QUANTITY" FooterText="Quantity" HeaderText="Quantity" />
                        ...
                        <tr>
                            ...
                            <tr>
                                <td class="style72">
                                <asp:Label ID="Label1" runat="server" Text="SMNG Comment" Font-Size="12px" 
                                 ForeColor="Maroon" Visible="False"></asp:Label>
                                 </td>
                           ...
                           <tr>
                            ...
                            <td>
                             <asp:Label ID="Label2" runat="server" Text="Issue by" Font-Size="12px" 
                                 ForeColor="Maroon" Visible="False"></asp:Label>
