...
public partial class UsersArea_Admin_Staff_Fun : System.Web.UI.Page
{
    ...
    public void GridViewBind()
    {
        ...
        //SELECT STOCK_REQUEST.ORDER_NO ,STOCK_REQUEST.CREATED_USER ,STOCK_REQUEST.ORDER_DATE,STOCK_REQUEST.CREATED_ID,EMPLOYEES.EMPLOYEE_NAME ,STOCK_REQUEST.DEP_NO FROM STOCK_REQUEST,DEPARTMENTS,EMPLOYEES  WHERE STOCK_REQUEST.CREATED_ID=EMPLOYEES.EMPLOYEE_NO AND STOCK_REQUEST.STATUS= '11'AND STOCK_REQUEST.DEP_NO= DEPARTMENTS.DEP_NO AND REQUEST_EXCUTOR='9633' 
    ...
    void A_comment()
    {
        ...
        if (read.HasRows)
        {
            TextBox4.Text = read["ADMIN_COMMENT"].ToString();
    ...
    private void UpdateFormStatus()
    {
        ...
        if (TextBox1.Text != "")
        {
                ...
                sql = "UPDATE STOCK_REQUEST SET STATUS = '13' WHERE STOCK_REQUEST.ORDER_NO='" + TextBox1.Text + "'";
     ...
     private void ExportGridToPDF()
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=FunitureRequest.pdf");
