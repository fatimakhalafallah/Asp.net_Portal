<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ICT_EAPPR.aspx.cs" MasterPageFile="~/UsersArea/MasterPage.master" Inherits="UsersArea_ICT_EAPPR" %>
                    ...
                    <table cellpadding="0" cellspacing="0" class="style7">
                        ...
                        <tr>
                           ...
                           <tr>
                            ...
                            <td>
                             <asp:Label ID="Label2" runat="server" Text="Assign To" Font-Size="12px" 
                                 ForeColor="Maroon" Visible="False"></asp:Label>
