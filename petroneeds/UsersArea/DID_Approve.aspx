<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DID_Approve.aspx.cs" MasterPageFile="~/UsersArea/MasterPage.master" Inherits="UsersArea_DID_Approve" %>
    ...
    <table cellpadding="0" cellspacing="0" class="style7">
        <tr>
            <td colspan="3" class="style40">
                ...
                <asp:Image ID="Image18" runat="server" ImageUrl="~/images/DID 2.PNG"  Height="37px" />
                </b>
            </td>
        </tr>
        <tr>
                    ...
                    <table cellpadding="0" cellspacing="0" class="style7">
                        ...
                        <tr>
                            ...
                            <tr>
                                ...
                                <td class="style63" rowspan="1">
                                    <asp:Label ID="sm_l" runat="server" Font-Size="12px" ForeColor="Maroon" 
                                        Text="SMNG Comment" Visible="False"></asp:Label>
                                    <br />
                                    <br />
                                </td>
                                <td>
                                    ...
                                    <asp:TextBox ID="sm_c" runat="server" BorderColor="#B00000" 
                            ...
                            <td>
                                ...
                                <asp:Label ID="gm_l" runat="server" Text="GM Comment" Font-Size="12px" ForeColor="Maroon"  Visible="False" ></asp:Label>
                            
                                      
                            
                            </td>
                            <td>
                            <asp:TextBox ID="gm_b" runat="server" BorderColor="#B00000" 
                                        BorderStyle="Inset" BorderWidth="1px" Height="67px" TextMode="MultiLine" 
                                        Width="346px" ReadOnly="True" Visible="False"></asp:TextBox>
