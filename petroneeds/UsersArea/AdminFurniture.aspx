<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminFurniture.aspx.cs"  MasterPageFile="~/UsersArea/MasterPage.master"  Inherits="UsersArea_AdminFurniture" %>
                       ...
                       <td>
                        ...
                        <td>
                            <asp:TextBox ID="TextBox3" runat="server" BorderColor="#B00000" 
                                ...
                                Visible="true" Width="346px"></asp:TextBox>
                        </td>
                        </tr>
                        <tr>
                            <td class="style56">
