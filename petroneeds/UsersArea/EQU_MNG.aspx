<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EQU_MNG.aspx.cs"  MasterPageFile="~/UsersArea/MasterPage.master" Inherits="UsersArea_EQU_MNG" %>
...
<asp:Content ID="Content2" runat="server" contentplaceholderid="ContentPlaceHolder2">
      ...
      <asp:GridView ID="grid1" EmptyDataText="No data to display" runat="server" AutoGenerateColumns="False" 
        ...
        BackColor="White" BorderColor="#f7f7f7"  Width="595px"  
          DataKeyNames="FORM_NO" style="margin-top: 7px" 
        onselectedindexchanged="grid1_SelectedIndexChanged1" CellPadding="3" 
          CellSpacing="1" ForeColor="#B00000" ShowHeaderWhenEmpty="True" 
       > 
       ...
       <asp:BoundField DataField="REQUESTER_NAME" HeaderText="Employee Name"/>  
       <asp:BoundField DataField="DEP_NO" HeaderText="Employee DEP"/>
