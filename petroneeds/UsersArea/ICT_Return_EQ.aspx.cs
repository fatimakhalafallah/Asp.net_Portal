...
public partial class UsersArea_ICT_Return_EQ : System.Web.UI.Page
{
    ...
    void Comments_Field()
    {
        ...
        string connectionString = ConfigurationManager.ConnectionStrings["PetroneedsConnectionString"].ConnectionString;
        string sql = "SELECT ICT_MSTR.IMNG_COMMENT FROM ICT_MSTR WHERE ICT_MSTR.FORM_STATUS='8' AND ICT_MSTR.EMPLOYEE_NO= '" + EMPLOYEE_NO + "'";
    ...
    protected void OnRowUpdating(object sender, GridViewUpdateEventArgs e)
    {
                        ...
                        string EQ_NAME = (row.FindControl("txtEQ") as TextBox).Text;
                        string QUANTITY = (row.FindControl("txtQU") as TextBox).Text;
                        string DESCRIPTION = (row.FindControl("txtDE") as TextBox).Text;
