...
public partial class TRY2 : System.Web.UI.Page
{
    ...
    private DataView Getdata()
    {
        ...
        string sql = "SELECT TRAVEL_PURPOSE.PURPOSE, TRAVEL_MSTR.TRF_NO ,TRAVEL_DTL.CITY_FROM, TRAVEL_DTL.FROM_DATE ,TRAVEL_DTL.CITY_TO ,TRAVEL_DTL.TO_DATE,DECODE(TRAVEL_MSTR.FORM_STATUS,2,'MANAGER APPROVE',3,'MANAGER DISAPPROVE',4,'DGM APPROVE',5,'DGM DISAPPROVE',6,'HR APPROVE',7,'HR DISAPPROVE',8,'FINANCIAL MNG APPROVE',9,'FINANCIAL MNG DISAPPROVE',10,'COMPLETE') AS FORM_STATUS  FROM TRAVEL_DTL , TRAVEL_MSTR INNER JOIN TRAVEL_PURPOSE ON TRAVEL_MSTR.PURPOSE= TRAVEL_PURPOSE.SERIAL  WHERE TRAVEL_DTL.TRF_NO=TRAVEL_MSTR.TRF_NO AND TRAVEL_MSTR.EMPLOYEE_NO='" + Int32.Parse(EMPLOYEE_NO) + "'"
                         ;
