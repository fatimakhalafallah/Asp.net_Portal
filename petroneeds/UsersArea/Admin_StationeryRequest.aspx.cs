...
public partial class UsersArea_Admin_StationeryRequest : System.Web.UI.Page
{
    ...
    public void GridViewBind()
    {
        ...
        switch (No)
        {
            case 1:
                ...
                odbcdadapter = new OdbcDataAdapter("SELECT STOCK_REQUEST.ORDER_NO, STOCK_REQUEST.CREATED_ID, STOCK_REQUEST.CREATED_USER, STOCK_REQUEST.ORDER_DATE, DEPARTMENTS.DEP_NAME,EMPLOYEES.EMPLOYEE_NAME FROM STOCK_REQUEST, DEPARTMENTS, EMPLOYEES ,REQUEST_ACTORS WHERE EMPLOYEES.EMPLOYEE_NO = STOCK_REQUEST.CREATED_ID AND DEPARTMENTS.DEP_NO = STOCK_REQUEST.DEP_NO AND (STOCK_REQUEST.STATUS = '4' OR (STOCK_REQUEST.CREATED_ID IN(SELECT EMPLOYEE_NO FROM EMP_MNG WHERE MNG='" + STATIONERYAPP + "')) AND STOCK_REQUEST.STATUS = '3') AND REQUEST_ACTORS.REQUEST_TYPE_ID = '19' AND REQUEST_ACTORS.EMPLOYEE_NO= '" + STATIONERYAPP + "'", connectionString);
                //odbcdadapter = new OdbcDataAdapter("SELECT STOCK_REQUEST.ORDER_NO, STOCK_REQUEST.CREATED_ID, STOCK_REQUEST.CREATED_USER, STOCK_REQUEST.ORDER_DATE, DEPARTMENTS.DEP_NAME,EMPLOYEES.EMPLOYEE_NAME FROM STOCK_REQUEST, DEPARTMENTS, EMPLOYEES ,REQUEST_ACTORS WHERE EMPLOYEES.EMPLOYEE_NO = STOCK_REQUEST.CREATED_ID AND DEPARTMENTS.DEP_NO = STOCK_REQUEST.DEP_NO AND STOCK_REQUEST.STATUS = '4' AND REQUEST_ACTORS.REQUEST_TYPE_ID = '19' AND REQUEST_ACTORS.EMPLOYEE_NO= '" + STATIONERYAPP + "'", connectionString);
            ...
            case 2:
                ...
                odbcdadapter = new OdbcDataAdapter("SELECT DISTINCT STOCK_REQUEST.ORDER_NO,STOCK_REQUEST.CREATED_ID, STOCK_REQUEST.CREATED_USER, STOCK_REQUEST.ORDER_DATE, DEPARTMENTS.DEP_NAME," +
                     " EMPLOYEES.EMPLOYEE_NAME FROM STOCK_REQUEST, DEPARTMENTS, EMPLOYEES" +
                     " WHERE EMPLOYEES.EMPLOYEE_NO = STOCK_REQUEST.CREATED_ID AND DEPARTMENTS.DEP_NO = STOCK_REQUEST.DEP_NO AND STATUS = '3' AND " +
                ...
                RadioButtonList1.Items.Add(new ListItem("Approve", "4")); // 3 pending 
    ...
    public void SendEMail(string Status)
    {
        ...
        if (STATIONERYAPP == EMPLOYEE_NO & MANAGER == EMPLOYEE_NO)
        {
            Response.Redirect("~/UsersArea/E-mail.aspx?EMPLOYEE_NO=" + TextBox2.Text + "&DEP_NO=" + DEPARTMENT_NO + "&FULL_USER_NAME=" + EmpName + "&EMAIL=" + EmpEmail + "&DEP_NAME=" + Depart + "&REQSTATUS=" + Status + "&DATE=" + date + "" +
              "&ApprovalName=" + EmpName4 + "&ApprovalEmail=" + EmpEmail4 + "&REQNAME=Stationary Request(SR)&AUTHORNAME=" + EmpName3 + "");
        ...
        {
            Response.Redirect("~/UsersArea/E-mail.aspx?EMPLOYEE_NO=" + TextBox2.Text + "&DEP_NO=" + DEPARTMENT_NO + "&FULL_USER_NAME=" + EmpName + "&EMAIL=" + EmpEmail + "&DEP_NAME=" + Depart + "&REQSTATUS=" + Status + "&DATE=" + date + "" +
              "&ApprovalName=" + EmpName3 + "&ApprovalEmail=" + EmpEmail3 + "&REQNAME=Stationary Request(SR)&AUTHORNAME=" + EmpName2 + "");
        }
