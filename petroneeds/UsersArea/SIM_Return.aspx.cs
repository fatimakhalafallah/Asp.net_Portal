...
public partial class UsersArea_SIM_Return : System.Web.UI.Page
{
    ...
    public static string EMPLOYEE_NO, FORMNO, EMSM, checkUser, DEPARTMENT_NO, ICMANAGER, SUPERVISOR, SINMANAGER, MANAGER;
    ...
    void Comments_Field()
    {
        ...
        string connectionString = ConfigurationManager.ConnectionStrings["PetroneedsConnectionString"].ConnectionString;
        string sql = "SELECT ICT_TELE.ICT_COMMENT, ICT_TELE.FORM_NO FROM ICT_TELE WHERE ICT_Tele.FORM_STATUS = '6'AND ICT_TELE.FORM_NO='" + TextBox1.Text + "'";
    ...
    protected void OnRowEditi(object sender, GridViewEditEventArgs e)
    {
    ...
    protected void OnRowCancel(object sender, EventArgs e)
    ...
    protected void OnRowUpdating(object sender, GridViewUpdateEventArgs e)
    {
                       ...
                       // string FORM_NO = (row.FindControl("txtfo") as TextBox).Text;
                        ...
                        string SimType = (row.FindControl("txtty") as TextBox).Text;
                        string SimCeil = (row.FindControl("txtce") as TextBox).Text;
              ...
              string sql = "UPDATE ICT_TELE SET USER_NAME='" + USERNAME + "' , USER_DEP='" + DEP + "' , SIM_TYPE='" + SimType + "', SIM_CEIL='"+SimCeil+"' WHERE FORM_NO='" + FORM_NO + "'"; 
    ...
    protected void OnRowUpdate(object sender, GridViewUpdateEventArgs e)
    {
            ...
            //sim_ceil sim_typ new_user user_dep user_name form_no

                        GridViewRow row = GridView3.Rows[e.RowIndex];
                        int FORM_NO = Convert.ToInt32(GridView3.DataKeys[e.RowIndex].Values[0]);
                       
                        string USERNAME = (row.FindControl("user_name") as TextBox).Text;
                        string DEP = (row.FindControl("user_dep") as TextBox).Text;
                        string newuser = (row.FindControl("new_user") as TextBox).Text;
                        string SimType = (row.FindControl("sim_typ") as TextBox).Text;
                        string SimCeil = (row.FindControl("sim_ceil") as TextBox).Text;
              ...
              connection = rootCfg.ConnectionStrings.ConnectionStrings["petroneedsConnectionString"].ConnectionString.ToString();
               ...
               //string sql = "UPDATE ICT_EDETAIL SET FORM_NO='" + FORM_NO + " ', EQ_NAME='" + EQ_NAME + "', QUANTITY='" + QUANTITY + "' , DESCRIPTION='" + DESCRIPTION + "' WHERE REQ_NO='" + REQ_NO + "' AND FORM_NO='" + FORM_NO + "'";
              string sql = "UPDATE ICT_TELE SET USER_NAME='" + USERNAME + "' , USER_DEP='" + DEP + "', NEW_USER='" + newuser + "' , SIM_TYPE='" + SimType + "', SIM_CEIL='" + SimCeil + "' WHERE FORM_NO='" + FORM_NO + "'"; 
    ...
    {    
     ...
     protected void requestUpdate()
     {
         ...
         if (TextBox1.Text != "")
         {
             ...
             sql = " UPDATE ICT_TELE SET FORM_STATUS = '1' WHERE FORM_NO = '" + TextBox1.Text + "'"; 
             con = new OdbcConnection(connection);
             con.ConnectionString = connection;
             con.Open();
