<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SIM_IT.aspx.cs" MasterPageFile="~/UsersArea/MasterPage.master" Inherits="UsersArea_SIM_IT" %>
                    ...
                    <table cellpadding="0" cellspacing="0" class="style7">
                        <tr>
                            <td class="style19" colspan="2">
                                Request Details:<asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="USER_NAME" FooterText="" HeaderText="Requester" />
                                    ...
                                    <FooterStyle BackColor="#B00000" Font-Bold="True" Font-Size="12px" 
                                        ForeColor="#808080" />
                                    <HeaderStyle BackColor="#B00000" BorderColor="#B00000" 
