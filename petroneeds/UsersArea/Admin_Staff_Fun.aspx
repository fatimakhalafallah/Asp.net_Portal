<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/UsersArea/MasterPage.master" CodeFile="Admin_Staff_Fun.aspx.cs" Inherits="UsersArea_Admin_Staff_Fun" %>
                                ...
                                <tr>
                                    ...
                                    <td class="style17">
                                        <asp:TextBox ID="TextBox4" runat="server" BorderColor="#B00000" 
                                            BorderStyle="Solid" BorderWidth="1px" Height="63px" ReadOnly="True" 
                                            TextMode="MultiLine" Visible="False" Width="346px"></asp:TextBox>
                                    </td>
                                    <td class="style18">
                                    </td>
                                </tr>
