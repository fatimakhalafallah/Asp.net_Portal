<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation ="false" CodeFile="SIM_MNG.aspx.cs" MasterPageFile="~/UsersArea/MasterPage.master" Inherits="UsersArea_SIM_MNG" %>
...
<asp:Content ID="Content2" runat="server" contentplaceholderid="ContentPlaceHolder2">
      ...
      <asp:GridView ID="grid1" EmptyDataText="No data to display" runat="server" AutoGenerateColumns="False" 
        ...
        onselectedindexchanged="grid1_SelectedIndexChanged1" ShowHeaderWhenEmpty="True" CellPadding="3" CellSpacing="1" ForeColor="#B00000" 
       > 
       ...
       <asp:BoundField DataField="USER_DEP" HeaderText="Employee DEP"/>
