<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Account_approve.aspx.cs" MasterPageFile="~/UsersArea/MasterPage.master" Inherits="UsersArea_Account_approve" %>
    ...
    <table cellpadding="0" cellspacing="0" class="style7">
        <tr>
            <td colspan="3" class="style40">
                ...
                <asp:Image ID="Image18" runat="server" ImageUrl="~/images/ICT_email.png" Height="41px" />
                </b>
            </td>
        </tr>
        <tr>
               ...
               <asp:GridView ID="GridView1" runat="server" Width="600px" AllowPaging="True" 
                    ...
                    <Columns>
                        <asp:BoundField DataField="FORM_NO" FooterText="Form No" HeaderText="Form No" 
                            />
                        <asp:BoundField DataField="REQUEST_USER_ID" FooterText="Employee No" 
                            HeaderText="Employee No" />
                             <asp:BoundField DataField="REQUEST_USER" FooterText="Employee Name" HeaderText="Employee Name" 
                            />
                        ...
                        <tr>
                            <td class="style46" colspan="3">
                                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
                                    ...
                                    <Columns>
                                         <asp:BoundField DataField="FORM_NO" FooterText="FORM NO" 
                                            HeaderText="FORM NO" />
                                        <asp:BoundField DataField="USER_FULL_NAME"  
                                            HeaderText="New User" />
                                        <asp:BoundField DataField="USER_DEPARTMENT" FooterText="User Department" HeaderText="User Department" />
                                        <asp:BoundField DataField="ACCOUNT_TYPE"  
                                            HeaderText="Account Type" FooterText="Account Type"  />
                                            <asp:BoundField DataField="START_DATE"  
                                            HeaderText="Start Date" FooterText="Start Date" />
                                            <asp:BoundField DataField="END_DATE"  
                                            HeaderText="End Date" FooterText="End Date" />
                                    </Columns>
