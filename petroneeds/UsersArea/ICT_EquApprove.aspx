<%@ Page Title="" Language="C#" MasterPageFile="~/UsersArea/MasterPage.master" AutoEventWireup="true" CodeFile="ICT_EquApprove.aspx.cs" Inherits="UsersArea_ICT_EquApprove" %>
                    ...
                    <table cellpadding="0" cellspacing="0" class="style7">
                        ...
                        <tr>
                           ...
                           <tr>
                            ...
                            <td>
                             <asp:Label ID="Label2" runat="server" Text="Execute by" Font-Size="12px" 
                                 ForeColor="Maroon" Visible="False"></asp:Label>
