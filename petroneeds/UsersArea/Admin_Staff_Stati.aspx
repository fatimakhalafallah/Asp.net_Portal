<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/UsersArea/MasterPage.master"  CodeFile="Admin_Staff_Stati.aspx.cs" Inherits="UsersArea_Admin_Staff_Stati" %>
        ...
        <tr>
            ...
            <td class="style9">
               <asp:GridView ID="GridView1" runat="server" Width="600px" AllowPaging="True" 
                    ...
                    onpageindexchanging="GridView1_PageIndexChanging" ForeColor="Maroon" ShowFooter="True" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="CREATED_ID" FooterText="Employee No" 
                            HeaderText="Employee No" />
                             <asp:BoundField DataField="EMPLOYEE_NAME" FooterText="Employee Name" HeaderText="Employee Name" 
                            />
                    ...
                    <table cellpadding="0" cellspacing="0" class="style7">
                        ...
                        <tr>
                            <td class="style46" colspan="3">
                                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
                                    ...
                                    <Columns>
                                         <asp:BoundField DataField="REQ_NO" FooterText="Order No" 
                                            HeaderText="Order No" />
                                        <asp:BoundField DataField="ITEM_NO" FooterText="Item Name" 
                                            HeaderText="Item Name" />
                                        <asp:BoundField DataField="QTY_ORDERED" FooterText="QUNTITY" HeaderText="QUNTITY" />
                        ...
                        <tr>
                           ...
                           <tr>
                                ...
                                <tr>
                                    <td class="style43">
                                        <asp:Label ID="Label6" runat="server" Font-Size="12px" ForeColor="Maroon" 
                                            Text="Admin MNG Comment" Visible="False"></asp:Label>
                                    </td>
                                    <td class="style17">
                                        <asp:TextBox ID="TextBox3" runat="server" BorderColor="#B00000" 
                                            BorderStyle="Solid" BorderWidth="1px" Height="63px" TextMode="MultiLine" 
                                            Visible="False" Width="346px"></asp:TextBox>
                                    </td>
                                    <td class="style18">
                                    </td>
                                </tr>
