...
public partial class UsersArea_Account_IT : System.Web.UI.Page
{
    ...
    public void GridViewBind()
    {
        ...
        DEPARTMENT_NO = Request.QueryString["DEP_NO"];
           ...
           DEPARTMENT_NO = Request.QueryString["DEP_NO"];
                ...
                dadapter = new OdbcDataAdapter("SELECT ICT_NEW_ACCOUNT.FORM_NO , ICT_NEW_ACCOUNT.FORM_DATE ,ICT_NEW_ACCOUNT.REQUEST_USER FROM ICT_NEW_ACCOUNT,DEPARTMENTS,EMPLOYEES  WHERE  ICT_NEW_ACCOUNT.REQUEST_USER_ID=EMPLOYEES.EMPLOYEE_NO AND ICT_NEW_ACCOUNT.FORM_STATUS= '4' AND ICT_NEW_ACCOUNT.REQUEST_DEP= DEPARTMENTS.DEP_NAME AND ICT_NEW_ACCOUNT.REQUEST_EXECUTOR='" + EMPLOYEE_NO + "'", connectionString);
                dset = new DataSet();
                dadapter.Fill(dset);
    ...
    void Comments_Field()
    {
        ...
        string connectionString = ConfigurationManager.ConnectionStrings["PetroneedsConnectionString"].ConnectionString;
        string sql = "SELECT ICT_NEW_ACCOUNT.IMNG_COMMENT FROM ICT_NEW_ACCOUNT WHERE ICT_NEW_ACCOUNT.FORM_STATUS='4' AND ICT_NEW_ACCOUNT.FORM_NO= '" + TextBox1.Text + "'";
    ...
    private void UpdateFormStatus()
    {
        ...
        if (TextBox1.Text != "")
        {
                ...
                sql = "UPDATE ICT_NEW_ACCOUNT SET FORM_STATUS = '7'WHERE FORM_NO = '" + TextBox1.Text + "'";
