<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/UsersArea/MasterPage.master" CodeFile="VehicleRequest_Return.aspx.cs" Inherits="UsersArea_VehicleRequest_Return" %>
    ...
    <table cellpadding="0" cellspacing="0" class="style7">
        ...
        <tr>
            ...
            <td class="style9">
                ...
                <asp:TextBox ID="TextBox4" runat="server" Visible="false" AutoPostBack="True"></asp:TextBox>
            </td>
            <td class="style29">
                &nbsp;</td>
        </tr>
                    ...
                    <table cellpadding="0" cellspacing="0" class="style7">
                            ...
                            <td class="style46" colspan="3">
                                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
                                    ...
                                    <AlternatingRowStyle BackColor="White" />
                                       ...
                                       <EditItemTemplate>
                                       <asp:TextBox ID="txtRE" runat="server" ReadOnly="true" Text='<%# Bind("REQ_NO") %>'></asp:TextBox>
                                        </EditItemTemplate>
                                       </asp:TemplateField>

                                        <asp:TemplateField HeaderText="Destination" ItemStyle-Width="150">
                                        <ItemTemplate>
                                        <asp:Label ID="formNumber" runat="server" Text='<%# Bind("DESTINATION") %>'></asp:Label>
                                       </ItemTemplate>
                                       <EditItemTemplate>
                                       <asp:TextBox ID="txtDE" runat="server" ReadOnly="true" Text='<%# Bind("DESTINATION") %>'></asp:TextBox>
                                        </EditItemTemplate>
                                       </asp:TemplateField>

                                        <asp:TemplateField HeaderText="Purpose" ItemStyle-Width="150">
                                        <ItemTemplate>
                                        <asp:Label ID="EQ" runat="server" Text='<%# Bind("PURPOSE") %>'></asp:Label>
                                       </ItemTemplate>
                                       <EditItemTemplate>
                                       <asp:TextBox ID="txtPU" runat="server" ReadOnly="true" Text='<%# Bind("PURPOSE") %>'></asp:TextBox>
                                        </EditItemTemplate>
                                       </asp:TemplateField>

                                       <asp:TemplateField HeaderText="Departure Day" ItemStyle-Width="150">
                                       <ItemTemplate>
                                        <asp:Label ID="QU" runat="server" Text='<%# Bind("DEPAR_DAY") %>'></asp:Label>
                                        </ItemTemplate>
                                      <EditItemTemplate>
                                    <asp:TextBox ID="txtDA" runat="server" Text='<%# Bind("DEPAR_DAY") %>'></asp:TextBox>
                                     </EditItemTemplate>
                                        </asp:TemplateField>

                                         <asp:TemplateField HeaderText="DEPAR_TIME" ItemStyle-Width="150">
                                        <ItemTemplate>
                                        <asp:Label ID="DE" runat="server" Text='<%# Bind("DEPAR_TIME") %>'></asp:Label>
                                       </ItemTemplate>
                                       <EditItemTemplate>
                                       <asp:TextBox ID="txtTI" runat="server" Text='<%# Bind("DEPAR_TIME") %>'></asp:TextBox>
                                        </EditItemTemplate>
                                       </asp:TemplateField>
                        ...
                        <tr>
                           ...
                           <tr>
                            ...
                            <tr>
                                <td class="style44">
                                    <asp:Label ID="Label4" runat="server" Text="Admin Comment" Font-Size="12px" ForeColor="Maroon"></asp:Label>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                </td>
