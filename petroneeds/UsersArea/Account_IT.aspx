<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Account_IT.aspx.cs" MasterPageFile="~/UsersArea/MasterPage.master" Inherits="UsersArea_Account_IT" %>
               ...
               <asp:GridView ID="GridView1" runat="server" Width="600px" AllowPaging="True" 
                    ...
                    <Columns>
                        <asp:BoundField DataField="FORM_NO" FooterText="Form No" HeaderText="Form No" 
                            />
                        <asp:BoundField DataField="FORM_DATE" FooterText="FORM_DATE" 
                            HeaderText="FORM_DATE" />
                                ...
                                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
                                    ...
                                    <Columns>
                                         ...
                                         <asp:BoundField DataField="FORM_NO" FooterText="FORM_NO" 
                                            HeaderText="FORM_NO" />
                                        <asp:BoundField DataField="USER_FULL_NAME" FooterText="User Name" 
                                            HeaderText="User Name" />
                                        <asp:BoundField DataField="USER_DEPARTMENT" FooterText="User Department" HeaderText="User Department" />
                                        <asp:BoundField DataField="ACCOUNT_TYPE" FooterText="Account Type" 
                                            HeaderText="Account Type" />
                                             <asp:BoundField DataField="START_DATE" FooterText="Start Date" 
                                            HeaderText="Start Date" />
                                             <asp:BoundField DataField="END_DATE" FooterText="End Date" 
                                            HeaderText="End Date" />
