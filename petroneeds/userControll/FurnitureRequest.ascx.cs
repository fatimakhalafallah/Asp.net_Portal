...
public partial class userControll_FurnitureRequest : System.Web.UI.UserControl
{
    ...
    private void ItemNo()
    {
        ...
        string sql = "SELECT ITEM_NAME_ENGLISH, ITEM_NO FROM PURCHASING_ITEMS_TAB WHERE GROUP_NO = '10611' ORDER BY ITEM_NAME_ENGLISH";
    ...
    private void Add_new(string FormNo, string FormDate)
    {
        ...
        if (DropDownList1.SelectedValue == "Other" & TextBox1.Text != "")
        {
            ...
            odbccon.Open();
            AddNewFormNu();
            sql = "INSERT INTO STOCK_REQUEST_DETAILS(ORDER_NO, REQ_NO, GROUP_NO, ITEM_NO, QTY_ORDERED, DESCRIPTION) VALUES('" + FormNo + "','" + Text_Bran_No.Text + "', '10611', '" +TextBox1.Text+ "', '" + Text_QTY.Text + "','" + Text_Description.Text + "')";
        ...
        else
        {
            ...
            odbccon.Open();
            AddNewFormNu();
            sql = "INSERT INTO STOCK_REQUEST_DETAILS(ORDER_NO, REQ_NO, GROUP_NO, ITEM_NO, QTY_ORDERED, DESCRIPTION) VALUES('" + FormNo + "','" + Text_Bran_No.Text + "', '10611', '" + DropDownList1.SelectedValue + "', '" + Text_QTY.Text + "','" + Text_Description.Text + "')";
