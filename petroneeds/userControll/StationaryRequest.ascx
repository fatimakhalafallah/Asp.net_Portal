<%@ Control Language="C#" AutoEventWireup="true" CodeFile="StationaryRequest.ascx.cs" Inherits="userControll_StationaryRequest" %>
                    ...
                    BorderStyle="Solid" Width="66px" BorderWidth="1px" ReadOnly="True" Visible="False"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td class="style94">
                                    ...
                                    <asp:TextBox ID="Text_QTY" runat="server"  Height="21px" BorderColor="#B00000" 
                                     BorderStyle="Solid" Width="200px" BorderWidth="1px" 
