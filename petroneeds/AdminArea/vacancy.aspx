<%@ Page Title="Petroneeds Services International :: Vacancy" Language="C#" MasterPageFile="~/AdminArea/MasterPage.master" AutoEventWireup="true" CodeFile="vacancy.aspx.cs" Inherits="AdminArea_vacancy" %>
    ...
    <table>
        <tr>
            ...
            <td class="style21" colspan="2">
                <asp:Image ID="Image34" runat="server" ImageUrl="~/images/ne_2.gif" />
            </td>
            <td class="style72">
                &nbsp;</td>
            <td class="style23">
                ...
                <table cellpadding="0" cellspacing="0" class="style70" __designer:mapid="63">
                    <tr __designer:mapid="64">
                        ...
                        <td class="style91" __designer:mapid="68">
                            &nbsp;</td>
                        <td class="style74" __designer:mapid="6a">
                            &nbsp;</td>
                        <td __designer:mapid="6b" class="style73">
                            &nbsp;</td>
