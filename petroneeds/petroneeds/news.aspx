...
<head runat="server">
   <title>PSI :: News And Events</title>
...
<div align="center">
  <table width="995" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td colspan="3" bgcolor="#FFFFFF"><table width="995" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="124" height="20"><a href="news.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image13','','images/li_09.jpg',1)">
              <img src="images/li_09.jpg" name="Image13" width="124" height="25" border="0" 
                  id="Image13" title="News" onmouseout="MM_startTimeout();" /></a></td>
          ...
          <td width="124" height="20"><a href="vacancy.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image42','','images/li_011.jpg',1)">
              <img src="images/li_11.jpg" name="Image42" width="124" height="25" border="0" 
    ...
    <tr>
      <td bgcolor="#FFFFFF">&nbsp;</td>
      <td bgcolor="#FFFFFF" class="style9"><div align="left">News And Events:</div></td>
