    ...
    <tr>
      <td colspan="3" bgcolor="#FFFFFF"><table width="995" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="124" height="20"><a href="vacancy.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image42','','images/li_011.jpg',1)"><img src="images/li_11.jpg" name="Image42" width="124" height="25" border="0" id="Image42" title="Vacancy" /></a></td>
      ...
      <td colspan="3" bgcolor="#FFFFFF"><table width="995" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td width="490" valign="top"><table width="490" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <th width="5" bgcolor="#B00000" scope="col">&nbsp;</th>
              <th scope="col"><div align="justify"><img src="images/h_1.gif" width="480" height="50" /></div></th>
              <th width="5" scope="col">&nbsp;</th>
            </tr>
            <tr>
              <td width="5" bgcolor="#B00000">&nbsp;</td>
              <td><div align="justify"></div></td>
              <td width="5">&nbsp;</td>
            </tr>
            <tr>
              <td width="5">&nbsp;</td>
              <td><div align="justify"><span class="style8"><strong>PSI</strong></span> since  inception in 1997 has earned a very high reputation amongst Sudanese Service  companies in the Oil Sector. <span class="style8"><strong>PSI</strong></span> took up an extreme diversification market  strategy as its main source of strength amongst its competitors; it is now not  only known for its Manpower &amp; Supply Services but also for its outstanding  performance in five giant new business areas: Turn Key Project Managements,  Drilling &amp; Its Associated Services, <a href="welcome.html">see more...</a></div></td>
              <td width="5">&nbsp;</td>
            </tr>
          </table></td>
          <td width="5">&nbsp;</td>
          <td width="490" valign="top"><table width="490" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <th width="5" bgcolor="#B00000" scope="col">&nbsp;</th>
              <th scope="col"><div align="justify"><img src="images/h_2.gif" width="480" height="50" /></div></th>
              <th width="5" scope="col">&nbsp;</th>
            </tr>
            <tr>
              <td width="5" bgcolor="#B00000">&nbsp;</td>
            ...
            <tr>
              <td height="96">&nbsp;</td>
              <td rowspan="2" valign="top"><div align="justify"><span class="style8"><strong>PSI</strong></span> since  inception in 1997 has earned a very high reputation amongst Sudanese Service  companies in the Oil Sector. PSI took up an extreme diversification market  strategy as its main source of strength amongst its competitors; it is now not  only known for its Manpower &amp; Supply Services but also for its outstanding  performance in five giant new business areas: Turn Key Project Managements,  Drilling &amp; Its Associated Services, <a href="welcome.html">see more...</a></div></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td width="5">&nbsp;</td>
      ...
      <td colspan="3" bgcolor="#FFFFFF"><table width="995" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td width="325" valign="top"><table width="325" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <th width="5" bgcolor="#B00000" scope="col">&nbsp;</th>
              <th width="315" valign="top" scope="col"><div align="justify"><img src="images/h_01.gif" width="315" height="30" /></div></th>
              <th width="5" scope="col">&nbsp;</th>
            </tr>
            <tr>
              <td width="5" bgcolor="#B00000">&nbsp;</td>
              <td width="315" valign="top"><div align="center"><img src="images/h_p_1.gif" width="157" height="120" /></div></td>
              <td width="5">&nbsp;</td>
            </tr>
            <tr>
              <td>&nbsp;</td>
            ...
            <tr>
              <td>&nbsp;</td>
              <td width="315" valign="top"><span class="style8"><strong>PSI</strong></span> aligns client’s  workforce strategy with the business strategy, improving work models and  increasing the agility <a href="manpower.html">see more...</a></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td>&nbsp;</td>
            ...
            <tr>
              ...
              <td width="315" valign="top"><img src="images/h_04.gif" width="315" height="30" /></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td bgcolor="#B00000">&nbsp;</td>
              <td width="315" valign="top"><div align="center"><img src="images/h_p_3.gif" width="157" height="120" /></div></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td>&nbsp;</td>
            ...
            <tr>
              <td width="5">&nbsp;</td>
              <td width="315" valign="top"><div align="justify"><span class="style8"><strong>PSI</strong></span> Supply Chain  Management Unit at Headquarters in Khartoum, Sudan oversees all the supply and <a href="supplyChain.html">see more...</a></div></td>
              <td width="5">&nbsp;</td>
            </tr>
          </table></td>
          <td width="5">&nbsp;</td>
          <td width="325" valign="top"><table width="325" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <th width="5" bgcolor="#B00000" scope="col">&nbsp;</th>
              <th width="315" valign="top" scope="col"><div align="justify"><img src="images/h_02.gif" width="315" height="30" /></div></th>
              <th width="5" scope="col">&nbsp;</th>
            </tr>
            <tr>
              <td width="5" bgcolor="#B00000">&nbsp;</td>
              <td width="315" valign="top"><div align="center"><img src="images/h_p_4.gif" width="157" height="120" /></div></td>
              <td width="5">&nbsp;</td>
            </tr>
            <tr>
              <td>&nbsp;</td>
            ...
            <tr>
              <td>&nbsp;</td>
              <td width="315" valign="top"><div align="justify">Although complexity and diversity of projects, we committed to deliver focus, clarity and real value <a href="projectMangement.html">see more...</a></div></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td>&nbsp;</td>
            ...
            <tr>
              <td bgcolor="#B00000">&nbsp;</td>
              <td width="315" valign="top"><img src="images/h_05.gif" width="315" height="30" /></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td bgcolor="#B00000">&nbsp;</td>
              <td width="315" valign="top"><div align="center"><img src="images/h_p_5.gif" width="157" height="120" /></div></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td>&nbsp;</td>
            ...
            <tr>
              <td width="5">&nbsp;</td>
              <td width="315" valign="top"><div align="justify"><span class="style8"><strong>PSI</strong></span>’s provides oil  field well service and work-over services coupled with more than 6 years of <a href="oilField.html">see more...</a></div></td>
              <td width="5">&nbsp;</td>
            </tr>
          </table></td>
          <td width="5">&nbsp;</td>
          <td width="325" valign="top"><table width="325" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <th width="5" bgcolor="#B00000" scope="col">&nbsp;</th>
              <th width="315" valign="top" scope="col"><div align="justify"><img src="images/h_03.gif" width="315" height="30" /></div></th>
              <th width="5" scope="col">&nbsp;</th>
            </tr>
            <tr>
              <td width="5" bgcolor="#B00000">&nbsp;</td>
            ...
            <tr>
              <td>&nbsp;</td>
              <td width="315" valign="top"><div align="justify">This Strategic  Business Unit has been established in 2007, Petroneeds Petroleum Services Unit (PPS)<a href="drilling.html"> see more...</a></div></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td>&nbsp;</td>
            ...
            <tr>
              <td bgcolor="#B00000">&nbsp;</td>
              <td width="315" valign="top"><img src="images/h_06.gif" width="315" height="30" /></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td bgcolor="#B00000">&nbsp;</td>
              <td width="315" valign="top"><div align="center"><img src="images/h_p_6.gif" width="157" height="120" /></div></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td>&nbsp;</td>
            ...
            <tr>
              <td width="5">&nbsp;</td>
              <td width="315" valign="top"><div align="justify">This unit developed  to utilize it’s workshops, knowledge and experience to provide assets <a href="workShop.html">see more...</a></div></td>
              <td width="5">&nbsp;</td>
            </tr>
          </table></td>
          <td width="5">&nbsp;</td>
    ...
    <tr>
      <td height="130" colspan="3" bgcolor="#F4F2EF"><table width="995" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td width="20">&nbsp;</td>
          <td width="170"><a href="community_Safety.html"><span class="style1">Community</span></a></td>
          <td width="20">&nbsp;</td>
          <td width="170">&nbsp;</td>
        </tr>
        <tr>
